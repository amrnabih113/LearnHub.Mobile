...
class RegisterForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isCompact = context.adaptive.isCompact;
      ...
      child: AdaptiveContent(
        ...
        child: ListView(
          ...
          children: [
            ...
            // TITLE
            Text('Create your LearnHub account', style: context.headlineLarge),
            ...
            if (isCompact)
              Column(
                children: [
                  _NameField(label: 'First Name', hint: 'John'),

                  SizedBox(height: context.gap(20)),

                  _NameField(label: 'Last Name', hint: 'Doe'),
                ],
              )
            else
              Row(
